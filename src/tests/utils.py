...
class APITest(TestCase):
    ...
    def setUp(self):
        ...
        user = User.objects.create_user(
            username="admin", email="admin@3megawat.local", password="admin"
        )
        user.is_staff = True
        ...
        user = User.objects.create_user(
            username="nobody", email="nobody@nobody.local", password="nobody"
        )
        user.is_staff = True
        ...
        user = User.objects.create_user(
            username="somebody", email="somebody@nobody.local", password="somebody"
        )
        user.is_staff = False
        user.is_superuser = False
        user.save()
